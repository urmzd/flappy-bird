...
public class Game {
    ...
    /**
     * The Game constructor initializes all the objects needed to open up a window containing
    ...
    /**
     * The checkScore() method determines if bird has passed a set of pipes and increments the score, in
    ...
    /**
     * The renderBird() method updates the position of the bird and renders the sprite.
     */
    ...
    /**
     * The renderPipes() method updates the position and renders all the sprites present within the pipes arraylist.
     */
    ...
    /**
     * The renderFloor() method updates the position of the floor and renders the sprite.
     */
    ...
    /**
     * The checkFloorCollision() method checks if the bird has the floor and if it has,
     * it stops the game.
     */
    ...
    /**
     * The checkFloorColliision() method checks if the bird has hit a pipe and if it has,
     * it plummets the bird to ground, in addition to stopping the movement of the pipes and
     * floor.
     */
