...
public class Bird extends Sprite {
     ...
     * in the Game.
     * 
     * @param position     A double array containing the (x,y) coordinates of the
     *                     Bird object.
     * @param velocity     A double array containing the (xVelocity, yVelocity) of
     *                     the Bird object.
     * @param acceleration A double array containing the (xAcceleration,
     *                     yAcceleration) of the Bird object.
     */
    ...
    /**
     * The update() method determines the status of the Bird object and updates it
    ...
    public void update() {
        ...
        // If the bird is alive and active (ready to play), update its rotation and
        // velocity values.
        if (alive && active) {
    ...
    /**
     * The updateType() method determines how many iterations have passed since last
     * image change
     ...
     * it goes in the upwards direction. It also sets the rotation value to some
     * value
     * to ensure its facing the sky while jumping. Lastly, it activates the active
     * status and
