...
public class Sprite implements Renderable, Updatable, Rotatable {
    ...
    /**
     * The updateImage() method changes the current image of the sprite and its
     * dimensions.
     * 
    ...
    /**
     * The update[vector] methods increments the current vector with the specified
     * values.
     * 
    ...
    /**
     * The stop() method stops the Sprite from moving by reducing the
     * acceleration(s) and velocities to 0.
     */
    public void stop() {
    ...
    /**
     * The getBoundingBox() creates a rectangle at the sprites current position with
     ...
     * 
     * @return A true value if the Sprite's BoundingBox intersects with another
     *         Sprite's BoundingBox.
     */
    ...
    /**
     * The update() method updates the current velocity and current position of the
     * Sprite.
     */
    @Override
    public void update() {
